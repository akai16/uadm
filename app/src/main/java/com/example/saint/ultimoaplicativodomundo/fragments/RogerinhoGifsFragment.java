...
public class RogerinhoGifsFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.mGifList = GifMock.getGifList(UADMConstantes.ROGERINHO_GIF_LIST);
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_rogerinho_gifs, container, false);
